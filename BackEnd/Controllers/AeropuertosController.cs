...
namespace BackEnd.Controllers
{
    ...
    public class AeropuertosController : ControllerBase
    {
        ...
        public AeropuertosController(MiContexto context)
        {
            _context = context;
        }
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Aeropuerto>> GetAeropuerto(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutAeropuerto(long id, Aeropuerto aeropuerto)
        {
            if (id != aeropuerto.Id)
            {
                return BadRequest();
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteAeropuerto(long id)
        {
            var aeropuerto = await _context.Aeropuertos.FindAsync(id);
            if (aeropuerto == null)
            {
